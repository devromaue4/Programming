...
namespace ExitGames.Client.DemoBasisCode
{
    ...
    /// <summary>
    /// This DemoPlayer extends the Playerclass from the LoadbalancginApi
    ...
    public class DemoPlayer : Player
    {
        ...
        public DemoPlayer(string name, int actorNr, bool isLocal) : base(name, actorNr, isLocal)
        {
        ...
        {
            return this.ID + "'" + this.Name + "':" + this.color.ToString() + " " + this.posX + ":" + this.posY + " PlayerProps: " + SupportClass.DictionaryToString(this.CustomProperties);
        }
